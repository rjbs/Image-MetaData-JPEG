...
Image::MetaData::JPEG::TagLists - This document is an appendix to the main
manual page of the L<Image::MetaData::JPEG> module, which the reader should
refer to for further details and the general scope. This document contains
a collection of tag tables for JPEG segments.
